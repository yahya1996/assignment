...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <form enctype="multipart/form-data" class="forms-sample" action="{{ route('categories.store')}}" method="post">
            @csrf
            <div class="row col-12">
              <div class="mb-3 col-md-6">
                <label for="title" class="form-label">Title</label>
                <input required name="create_title" type="text" class="form-control" id="title" autocomplete="off" placeholder="Title">
              </div>
              <div class="mb-3 col-md-6">
